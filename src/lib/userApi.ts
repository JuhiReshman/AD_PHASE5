...
export const registerUser = async (userData: User): Promise<void> => {
  try {
    const response = await axios.post(getApiUrl('USER_SERVICE', API_CONFIG.USER_SERVICE.ENDPOINTS.REGISTER), userData);
...
export const loginUser = async (loginData: LoginRequest): Promise<string> => {
  try {
    const response = await axios.post(getApiUrl('USER_SERVICE', API_CONFIG.USER_SERVICE.ENDPOINTS.LOGIN), loginData);
...
export const getCurrentUser = async (): Promise<UserResponse> => {
  try {
    const response = await axios.get(getApiUrl('USER_SERVICE', API_CONFIG.USER_SERVICE.ENDPOINTS.PROFILE));
    return response.data;
  } catch (error: any) {
    if (error.response?.data?.message) {
      throw new Error(error.response.data.message);
...
export const getUserById = async (userId: number): Promise<UserResponse> => {
  try {
    const response = await axios.get(getApiUrl('USER_SERVICE', API_CONFIG.USER_SERVICE.ENDPOINTS.BY_ID(userId)));
    return response.data;
  } catch (error: any) {
    if (error.response?.data?.message) {
      throw new Error(error.response.data.message);
...
export const updateUserProfile = async (userId: number, userData: UserProfileDto): Promise<UserResponse> => {
  try {
    const response = await axios.put(getApiUrl('USER_SERVICE', API_CONFIG.USER_SERVICE.ENDPOINTS.UPDATE_PROFILE(userId)), userData);
    return response.data;
  } catch (error: any) {
    if (error.response?.data?.message) {
      throw new Error(error.response.data.message);
...
export const getAllUsers = async (): Promise<UserResponse[]> => {
  try {
    const response = await axios.get(getApiUrl('USER_SERVICE', API_CONFIG.USER_SERVICE.ENDPOINTS.ALL));
    return response.data;
  } catch (error: any) {
    if (error.response?.data?.message) {
      throw new Error(error.response.data.message);
